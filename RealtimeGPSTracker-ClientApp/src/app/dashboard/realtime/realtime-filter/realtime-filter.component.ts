...
import { DeviceStatus, DeviceOrderBy } from 'src/app/core/models/device.model';
...
@Component({
  ...
  templateUrl: './realtime-filter.component.html',
  styleUrls: ['./realtime-filter.component.scss']
})
